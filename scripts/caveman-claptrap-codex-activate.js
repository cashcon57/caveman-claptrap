...
function loadSkillBody() {
  const skillPath = path.join(__dirname, '..', 'skills', 'caveman-claptrap', 'SKILL.md');
...
function fallbackBody() {
  return [
    ...
    '',
    'Default: **full**. Switch: `/claptrap lite|full|ultra|wenyan-lite|wenyan|wenyan-ultra`. `/caveman ...` stays as alias.',
    '',
    ...
    '## Boundaries',
    '',
    'Code/commits/PRs/file content: write normal. "stop claptrap" or "stop caveman" or "normal mode": revert immediately.'
  ].join('\n');
}
...
process.stdout.write('CLAPTRAP MODE ACTIVE — level: full\n\n' + body);
